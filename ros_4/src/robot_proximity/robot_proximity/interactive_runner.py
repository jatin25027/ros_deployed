...
def main():
    ...
    while True:
        try:
            spawn_time_str = input("Enter dynamic obstacle spawn interval in seconds (0 to disable dynamic obstacles): ").strip()
            spawn_time = float(spawn_time_str)
            if spawn_time >= 0:
                break
    ...
    # ----- Generate and launch -----
    launch_content = generate_launch_file_content(robots_config, spawn_time)
...
# ──────────────────────────────────────────────────────
def generate_launch_file_content(robots, spawn_time):
...
def generate_launch_description():
    ...
    src_config_dir = '/home/iiitd/Desktop/ros_full/ros_4/src/robot_proximity/config/simulation.rviz'
